...
import com.raihanresa.todolist.databinding.ActivityEditTaskBinding
...
class EditTaskActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val descriptionOld = intent.getStringExtra("description")
        val timeOld = intent.getStringExtra("time")
        val priorityOld = intent.getStringExtra("priority")
        val categoryOld = intent.getStringExtra("category")

        binding.titleEditText.setText(titleOld)
        binding.descriptionEditText.setText(descriptionOld)
        binding.addTimer.text = timeOld
        binding.addPriority.text = priorityOld
        ...
        binding.sendButton.setOnClickListener {
            ...
            taskViewModel.editTask(title, description, time, priority, category, id)
                .observe(this@EditTaskActivity) { result ->
                    when (result) {
                        ...
                        is ResultState.Error -> {
                            ...
                            val dialog = AlertDialog.Builder(this@EditTaskActivity)
